...
<body>
  ...
  <main>
    <?php if (_isAdmin()) : ?>
      <button class="flat" onClick="window.location.href = `/alpharocket/p/admin_book_add`" style="margin-bottom: 2em"><?php tr("წიგნის დამატება", "add new book") ?></button>
    ...
    <div class="main_grid">
      ...
      <?php foreach ($listBooks as $book) : ?>
        <a href="/alpharocket/p/book?u=<?php echo $book["id"] ?>" class="img_container">
