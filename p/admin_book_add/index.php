...
<head>
  ...
  <link rel="stylesheet" href="admin_book_add.css">
</head>
    ...
    <form>
      ...
      <div class="admin_book_edit-grid">
        <label class="file_image">
          ...
          <input required type="file" accept="image/png, image/jpeg, image/jpg, image/jpeg, image/webp" />
        </label>
      ...
      <div class="admin_book_edit-grid">
        ...
        <label class="txt">
          ...
          <input id="txtTitle" name="book_title" required />
        </label>
        ...
        <label class="txt">
          ...
          <input id="txtTitleGeo" name="book_title_geo" required />
        </label>
      ...
      <div class="admin_book_edit-grid">
        ...
        <label class="txt">
          ...
          <input id="txtAuthors" name="authors" required />
        </label>
        ...
        <label class="txt">
          ...
          <input id="txtAuthorsGeo" name="authors_geo" required />
        </label>
      ...
      <div class="admin_book_edit-grid">
        ...
        <label class="txt">
          ...
          <textarea id="txtDescriptionGeo"></textarea>
        </label>
      </div>
      ...
      <script>
        ...
        ui.form.addEventListener("submit", async e => {
          ...
          const response = fetch("/api/book_add.php", {
              method: 'POST',
              body: formData
            })
            ...
            .then(res => {
              ...
              window.location.href = `/p/book?u=${res.id}`;
            });
